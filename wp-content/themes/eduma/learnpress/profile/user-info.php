<div class="user-info">
	...
	<div class="author-avatar"><?php echo get_avatar( $user->ID, 270 ); ?></div>

	<div class="user-information">

		<?php
		$lp_info = get_the_author_meta( 'lp_info', $user->ID );
		?>
		...
		<h3 class="author-name"><?php echo esc_attr( $user->data->display_name ); ?></h3>
