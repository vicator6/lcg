...
<div class="quiz-results">
	<h4 class="result-title"><?php esc_html_e( 'Your result', 'eduma' ); ?></h4>
	...
	<div class="result-summary">
		...
		<div class="result-field empty">
			...
			<span class="value"><?php echo esc_attr($history->results['mark']); ?></span>
		</div>
		<div class="result-field points">
			<span><?php esc_html_e( 'Points', 'eduma' ); ?></span>
			<span class="value"><?php printf( '%d/%d', $history->results['mark'], count( $history->results['questions'] ) ); ?></span>
		</div>
