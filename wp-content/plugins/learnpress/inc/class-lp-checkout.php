...
class LP_Checkout{
    ...
    function create_order(){
        ...
        if( ! $transaction_object ){
            throw new Exception( sprintf( __( 'Sorry, your session has expired. <a href="%s">Return to homepage</a>', 'learnpress' ), home_url() ) );
        }
    ...
    function process_checkout(){
        ...
        if( ! $payment_method ){
            throw new Exception( __( 'The payment method is not available', 'learnpress' ) );
        }
