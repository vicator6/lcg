	...
	<ul class="lpr-curriculum-sections">
		...
		if ( $course_sections ): foreach ( $course_sections as $k => $section ): ?>
			...
			<li class="lpr-curriculum-section<?php echo $is_open ? "" : " closed"; ?>">
				<h3>
					...
					<span class="lpr-section-name-wrapper"><input name="_lpr_course_lesson_quiz[__SECTION__][name]" type="text" placeholder="<?php _e( 'Enter the section name and hit enter', 'learn_press' ); ?>" class="lpr-section-name" value="<?php echo esc_attr( $section['name'] ); ?>" /></span>
				</h3>
		...
		<li class="lpr-curriculum-section lpr-empty">
			<h3>
				...
				<!-- // actions -->
				<span class="lpr-section-icon"><i class="dashicons dashicons-pressthis"></i></span>
				<span class="lpr-section-name-wrapper"><input name="_lpr_course_lesson_quiz[__SECTION__][name]" type="text" placeholder="<?php _e( 'Enter the section name and hit enter', 'learn_press' ); ?>" class="lpr-section-name" /></span>
			</h3>
...
<script type="text/html" id="tmpl-curriculum-section">
	<li class="lpr-curriculum-section lpr-empty">
		<h3>
			...
			<!-- // actions -->
			<span class="lpr-section-icon"><i class="dashicons dashicons-pressthis"></i></span>
			<span class="lpr-section-name-wrapper"><input name="_lpr_course_lesson_quiz[__SECTION__][name]" type="text" placeholder="<?php _e( "Type section's name and hit enter", 'learn_press' ); ?>" class="lpr-section-name" /></span>
		</h3>
