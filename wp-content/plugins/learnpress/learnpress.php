...
if ( !class_exists( 'LearnPress' ) ) {
	...
	class LearnPress {
		...
		function init() {
			...
			$this->question_factory = LPR_Question_Factory::instance();
		...
		function includes() {
			...
			require_once 'inc/abstracts/abstract-lpr-question-type.php';
			...
			require_once 'inc/class-lpr-question-factory.php';
		 ...
		 * @return void
		 */
		public function learn_press_scripts() {
			return ;
